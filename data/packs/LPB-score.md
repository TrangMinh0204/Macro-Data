...
# Diem co hoc Q-G-V-T-D — LPB

**Diem_tho: 46/100** — Rui ro cao / luan diem chua du manh
**Do tin cay du lieu (D): 65/100**
**Gia dung de tinh V: 53,000**

## Q — Chat luong (trong so 30%)
- ROE (annualize x4): gia tri 21.8% → diem 98/100 (trong so 0.20)
- ROA (annualize x4): gia tri 1.7% → diem 63/100 (trong so 0.10)
- NIM (annualize x4): gia tri 2.6% → diem 2/100 (trong so 0.15)
- CIR (khong annualize): gia tri 35.2% → diem 79/100 (trong so 0.10)
- LDR (khong annualize, Score_band): gia tri 76.5% → diem 77/100 (trong so 0.10)

## G — Tang truong (trong so 20%)
- g_LNST (YoY): gia tri 5.2% → diem 38/100 (trong so 0.30)
- g_LNTT (YoY): gia tri 5.3% → diem 38/100 (trong so 0.20)
- g_EPS (CAGR dai han, proxy): gia tri 19.8% → diem 74/100 (trong so 0.20)
- g_Tai_san (YoY): gia tri 19.8% → diem 75/100 (trong so 0.15)

## V — Dinh gia (trong so 25%)
- S_PE (tinh lai theo gia hien tai): gia tri 14.02x → diem 0/100 (trong so 0.30)
- S_PB (tinh lai theo gia hien tai): gia tri 3.68x → diem 0/100 (trong so 0.30)
- S_EY: gia tri 7.1% → diem 0/100 (trong so 0.20)

## T — Ky thuat va dong tien (trong so 20%)
- Trend (vi tri so MA20/50/200): gia tri 3/3 MA → diem 100/100 (trong so 0.25)
- Momentum (RSI+MFI): gia tri RSI 57.3 / MFI 56.1 → diem 67/100 (trong so 0.20)
- Volume (Vol/MA20 + huong OBV/VPT): gia tri 0.82x, OBV tang, VPT tang → diem 70/100 (trong so 0.20)
